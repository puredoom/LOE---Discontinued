...
public class DRBiome
{
    ...
    public static void FixAnimals(){
        ...
        DRCommander.addAnimals((Class) DREntityDorwinionPanda.class, 1, 1, 1, LOTRBiome.farHaradJungle);
        ...
        DRCommander.addAnimals((Class) DREntityNazgul.class, 1, 1, 1, LOTRBiome.morgulVale);
        DRCommander.addAnimals((Class) DREntityNazgulHorse.class, 2, 1, 3, LOTRBiome.morgulVale);
        DRCommander.addAnimals((Class) DREntityCaragor.class, 2, 1, 2, LOTRBiome.mordor);
        DRCommander.addAnimals((Class) DREntityCaragor.class, 2, 1, 2, LOTRBiome.dagorlad);
        DRCommander.addAnimals((Class) DREntityCaragor.class, 1, 1, 2, LOTRBiome.brownLands);
        DRCommander.addAnimals((Class) DREntityCaragor.class, 1, 1, 2, LOTRBiome.loneLands);
        DRCommander.addAnimals((Class) DREntityCaragor.class, 1, 1, 2, LOTRBiome.wilderland);
        DRCommander.addAnimals((Class) DREntityCaragor.class, 1, 1, 2, LOTRBiome.rhunLandSteppe);
        DRCommander.addAnimals((Class) DREntityCaragor.class, 1, 1, 2, LOTRBiome.rhun);

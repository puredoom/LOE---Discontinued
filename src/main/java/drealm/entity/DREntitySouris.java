...
public class DREntitySouris
    ...
    public DREntitySouris(World world) {
        super(world);
        setSize(1.6f, 1.8f);
    ...
    protected void dropFewItems(final boolean p_70628_1_, final int p_70628_2_) {
        ...
        if (this.rand.nextFloat() < 0.25) {
            this.dropItem(DRRegistry.batwing, 1);
        }
    }
        ...
        if (flag && (attacker = damagesource.getEntity()) instanceof EntityLivingBase) {
            if (isChild()) {
                ...
                for (Object obj : list) {
                    ...
                    if (!(entity instanceof DREntitySouris) || (bear = (DREntitySouris) entity).isChild()) {
                        continue;
                    }

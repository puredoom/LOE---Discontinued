...
public class DREntityTrollGundabad extends LOTREntityHorse
{

    private static final ResourceLocation Textures;

    public boolean isAttacking; // New property
    ...
    public DREntityTrollGundabad(final World world) {
        super(world);
    ...
    public EntityAgeable createChild(final EntityAgeable entity) {
        return (EntityAgeable)new DREntityTrollGundabad(this.worldObj);
    }
    ...
    public final double getMountedYOffset() {
        double d = this.getBaseMountedYOffset() - 0.5;
    ...
    public void onLivingUpdate() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (!this.isMountSaddled() && this.getEntityAttribute(SharedMonsterAttributes.maxHealth).getBaseValue() != 1300.0) {
                this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(1300.0);
    ...
    protected void dropFewItems(final boolean p_70628_1_, final int p_70628_2_) {
        ...
        if (this.rand.nextFloat() < 0.25) {
            this.dropItem(DRRegistry.trollfoot, 1);
        }
    }

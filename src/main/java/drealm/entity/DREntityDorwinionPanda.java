...
public class DREntityDorwinionPanda extends LOTREntityHorse
{
    ...
    public DREntityDorwinionPanda(final World world) {
        super(world);
    ...
    public final double getMountedYOffset() {
        double d = this.getBaseMountedYOffset() - 0.2;
    ...
    protected void dropFewItems(final boolean p_70628_1_, final int p_70628_2_) {
        ...
        this.dropItem(DRRegistry.axeRedDwarven, 1);

...
public class DREntityMorgoth
    ...
    public DREntityMorgoth(World world) {
        super(world);
        setSize(1.6f, 1.8f);
    ...
    public boolean attackEntityFrom(DamageSource damagesource, float f) {
        ...
        if (flag && (attacker = damagesource.getEntity()) instanceof EntityLivingBase) {
            if (isChild()) {
                ...
                for (Object obj : list) {
                    DREntityMorgoth bear;
                    Entity entity = (Entity) obj;
                    if (!(entity instanceof DREntityMorgoth) || (bear = (DREntityMorgoth) entity).isChild()) {
                        continue;
                    }

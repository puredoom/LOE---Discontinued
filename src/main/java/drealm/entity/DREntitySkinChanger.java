...
public class DREntitySkinChanger
    ...
    public DREntitySkinChanger(World world) {
        super(world);
        setSize(1.6f, 1.8f);
    ...
    protected void dropFewItems(final boolean p_70628_1_, final int p_70628_2_) {
        ...
        if (this.rand.nextFloat() < 0.40) {
            this.dropItem(DRRegistry.skinchangerfur, 1);
        }
    }
    ...
    public boolean attackEntityFrom(DamageSource damagesource, float f) {
        ...
        if (flag && (attacker = damagesource.getEntity()) instanceof EntityLivingBase) {
            if (isChild()) {
                ...
                for (Object obj : list) {
                    DREntitySkinChanger bear;
                    Entity entity = (Entity) obj;
                    if (!(entity instanceof DREntitySkinChanger) || (bear = (DREntitySkinChanger) entity).isChild()) {
                        continue;
                    }

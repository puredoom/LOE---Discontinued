...
public class DREntityPoney extends LOTREntityHorse
{
    ...
    public DREntityPoney(final World world) {
        super(world);
    ...
    protected double getBaseMountedYOffset() {
        return this.height - 0.8500000011920929;
    }
    ...
    protected void dropFewItems(final boolean p_70628_1_, final int p_70628_2_) {
        ...
        if (this.rand.nextFloat() < 0.25) {
            this.dropItem(DRRegistry.hobbitleather, 1);
        }
    }
}

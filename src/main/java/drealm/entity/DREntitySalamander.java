...
public class DREntitySalamander extends LOTREntityHorse
{
    ...
    public DREntitySalamander(final World world) {
        super(world);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(85.0);
    ...
    public EntityAgeable createChild(final EntityAgeable entity) {
        return (EntityAgeable)new DREntitySalamander(this.worldObj);
    }

    
    public final double getMountedYOffset() {
        double d = this.getBaseMountedYOffset() - 0.75;
    ...
    protected void dropFewItems(final boolean p_70628_1_, final int p_70628_2_) {
        ...
        if (this.rand.nextFloat() < 0.15) {
            this.dropItem(DRRegistry.salamandertail, 1);
        }
    }
}

...
public class DRModelGondorWerewolf extends ModelBase {
	...
	public DRModelGondorWerewolf() {
		textureWidth = 128;
		textureHeight = 128;

		body = new ModelRenderer(this);
		body.setRotationPoint(0.0F, 6.0F, 0.0F);
		body.cubeList.add(new ModelBox(body, 63, 22, -3.0F, -16.0F, -9.0F, 6, 4, 6, 0.0F));
		...
		legG.setRotationPoint(4.0F, -16.0F, 0.0F);
		legs.addChild(legG);
		legG.cubeList.add(new ModelBox(legG, 63, 0, -1.0F, 15.0F, -3.0F, 2, 1, 4, 0.0F));

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(-4.0F, 10.0F, 1.0F);
		...
		legD.setRotationPoint(-4.0F, -16.0F, 0.0F);
		legs.addChild(legD);
		legD.cubeList.add(new ModelBox(legD, 54, 53, -1.0F, 15.0F, -3.0F, 2, 1, 4, 0.0F));

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(4.0F, 10.0F, 1.0F);
		...
		cube_r10.setRotationPoint(4.0F, -1.0F, 0.0F);
		...
		head.cubeList.add(new ModelBox(head, 62, 50, -4.0F, -6.0F, -6.0F, 8, 8, 8, 0.0F));
		head.cubeList.add(new ModelBox(head, 47, 77, -2.0F, -3.0F, -13.0F, 4, 2, 7, 0.0F));
		head.cubeList.add(new ModelBox(head, 32, 74, 1.0F, -1.0F, -14.0F, 2, 1, 9, -1.0F));
		head.cubeList.add(new ModelBox(head, 54, 50, -3.0F, -1.0F, -14.0F, 6, 1, 2, -1.0F));
		head.cubeList.add(new ModelBox(head, 72, 32, -3.0F, -1.0F, -14.0F, 2, 1, 9, -1.0F));

		cube_r23 = new ModelRenderer(this);
		cube_r23.setRotationPoint(-3.0F, -5.0F, 1.0F);
		...
		cube_r24.setRotationPoint(3.0F, -5.0F, 1.0F);
		...
		maw.setRotationPoint(0.0F, 35.0F, 6.0F);
		head.addChild(maw);

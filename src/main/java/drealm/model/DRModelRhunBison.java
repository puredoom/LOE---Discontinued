...
public class DRModelRhunBison extends ModelBase {
	...
	public DRModelRhunBison() {
		textureWidth = 256;
		textureHeight = 256;

		body = new ModelRenderer(this);
		body.setRotationPoint(0.0F, 4.0F, 16.0F);
		body.cubeList.add(new ModelBox(body, 76, 47, 0.0F, -23.0F, -37.0F, 0, 9, 13, 0.0F));
		body.cubeList.add(new ModelBox(body, 96, 71, -1.0F, -3.0F, 4.0F, 2, 6, 2, 0.0F));
		body.cubeList.add(new ModelBox(body, 113, 51, -2.0F, 2.0F, 3.0F, 4, 5, 4, 0.0F));
		body.cubeList.add(new ModelBox(body, 96, 60, -5.0F, 5.0F, -9.0F, 10, 2, 9, 0.0F));
		body.cubeList.add(new ModelBox(body, 53, 0, -7.0F, 4.0F, -33.0F, 14, 2, 21, 0.0F));

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(-2.3F, 8.2F, -6.0F);
		...
		cube_r2.setRotationPoint(-1.7F, 8.4F, -3.0F);
		...
		cube_r3.setRotationPoint(1.7F, 8.4F, -3.0F);
		...
		cube_r4.setRotationPoint(2.3F, 8.2F, -6.0F);
		...
		cube_r6.setRotationPoint(0.0F, -14.0F, -36.0F);
		...
		cube_r7.setRotationPoint(0.0F, -14.0F, -36.0F);
		...
		cube_r8.setRotationPoint(0.0F, 6.0F, -1.0F);
		body.addChild(cube_r8);
		setRotationAngle(cube_r8, 0.0F, 0.0F, 0.0873F);
		cube_r8.cubeList.add(new ModelBox(cube_r8, 59, 26, -10.0F, -17.0F, -13.0F, 10, 17, 17, 0.0F));

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(0.0F, -15.0F, -15.0F);
		...
		cube_r10.setRotationPoint(0.0F, -15.0F, -15.0F);
		...
		cube_r11.setRotationPoint(0.0F, 6.0F, -1.0F);
		body.addChild(cube_r11);
		setRotationAngle(cube_r11, 0.0F, 0.0F, -0.0873F);
		cube_r11.cubeList.add(new ModelBox(cube_r11, 59, 69, 0.0F, -17.0F, -13.0F, 10, 17, 17, 0.0F));

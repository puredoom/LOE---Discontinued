...
public class DRModelHighElfHelmet extends LOTRModelBiped {


	public DRModelHighElfHelmet () {
		textureWidth = 64;
		textureHeight = 64;
		...
		this.bipedHead.cubeList.add(new ModelBox(this.bipedHead, 42, 6, -5.0F, -8.5F, 3.9F, 2, 2, 1, 0.0F));
		...
		this.bipedHead.cubeList.add(new ModelBox(this.bipedHead, 6, 41, 3.0F, -8.5F, -4.8F, 2, 2, 1, 0.0F));
		...
		this.bipedHead.cubeList.add(new ModelBox(this.bipedHead, 41, 35, 3.0F, -8.5F, 3.9F, 2, 2, 1, 0.0F));

		ModelRenderer cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(-0.5F, -9.0F, -2.8F);
		this.bipedHead.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.48F, 0.0F, 0.0F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 40, 39, 0.0F, -3.0F, 0.0F, 1, 4, 1, 0.0F));

		ModelRenderer cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-0.5F, -12.0F, 2.3F);
		this.bipedHead.addChild(cube_r2);
		setRotationAngle(cube_r2, -0.0436F, 0.0F, 0.0F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 10, 28, 0.0F, -3.0F, -5.0F, 1, 3, 6, 0.0F));

		ModelRenderer cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(-0.5F, -11.9F, -3.7F);
		this.bipedHead.addChild(cube_r3);
		setRotationAngle(cube_r3, -0.0436F, 0.0F, 0.0F);
		cube_r3.cubeList.add(new ModelBox(cube_r3, 0, 44, 0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F));

		ModelRenderer cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-0.5F, -11.5F, 3.3F);
		this.bipedHead.addChild(cube_r4);
		setRotationAngle(cube_r4, -0.0436F, 0.0F, 0.0F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 4, 44, 0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F));

		ModelRenderer cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(-0.5F, -10.4F, -3.6F);
		this.bipedHead.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.2618F, 0.0F, 0.0F);
		cube_r5.cubeList.add(new ModelBox(cube_r5, 7, 37, 0.0F, -3.0F, -4.0F, 1, 1, 3, 0.0F));

		ModelRenderer cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(-0.5F, -11.2F, -4.5F);
		this.bipedHead.addChild(cube_r6);
		setRotationAngle(cube_r6, 0.6109F, 0.0F, 0.0F);
		cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 34, 0.0F, -3.0F, -4.0F, 1, 1, 4, 0.0F));
		cube_r6.cubeList.add(new ModelBox(cube_r6, 12, 41, 0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F));

		ModelRenderer cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(-0.5F, -11.3F, -4.7F);
		this.bipedHead.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.2618F, 0.0F, 0.0F);
		cube_r7.cubeList.add(new ModelBox(cube_r7, 16, 42, 0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F));

		ModelRenderer cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(-0.5F, -11.5F, -4.7F);
		this.bipedHead.addChild(cube_r8);
		setRotationAngle(cube_r8, -0.0436F, 0.0F, 0.0F);
		cube_r8.cubeList.add(new ModelBox(cube_r8, 43, 43, 0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F));

		ModelRenderer cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(-0.5F, -10.5F, 5.3F);
		this.bipedHead.addChild(cube_r9);
		setRotationAngle(cube_r9, -0.0436F, 0.0F, 0.0F);
		cube_r9.cubeList.add(new ModelBox(cube_r9, 20, 41, 0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F));

		ModelRenderer cube_r10 = new ModelRenderer(this);
		cube_r10.setRotationPoint(-0.5F, -11.0F, 4.3F);
		this.bipedHead.addChild(cube_r10);
		setRotationAngle(cube_r10, -0.0436F, 0.0F, 0.0F);
		cube_r10.cubeList.add(new ModelBox(cube_r10, 8, 44, 0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F));

		ModelRenderer cube_r11 = new ModelRenderer(this);
		cube_r11.setRotationPoint(-0.5F, -9.0F, 2.9F);
		this.bipedHead.addChild(cube_r11);
		setRotationAngle(cube_r11, -0.5672F, 0.0F, 0.0F);
		cube_r11.cubeList.add(new ModelBox(cube_r11, 44, 9, 0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F));
		...
		HatLayer_r2.cubeList.add(new ModelBox(HatLayer_r2, 0, 34, -0.5F, -0.4F, 0.5F, 1, 3, 1, 0.0F));
		...
		HatLayer_r3.cubeList.add(new ModelBox(HatLayer_r3, 6, 34, -0.5F, -0.4F, 0.5F, 1, 3, 1, 0.0F));
		...
		HatLayer_r4.cubeList.add(new ModelBox(HatLayer_r4, 44, 22, -3.5F, -5.5F, -0.1F, 1, 2, 1, 0.0F));
		...
		HatLayer_r5.cubeList.add(new ModelBox(HatLayer_r5, 35, 44, 2.5F, -5.5F, -0.1F, 1, 2, 1, 0.0F));

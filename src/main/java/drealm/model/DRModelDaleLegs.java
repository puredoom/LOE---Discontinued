...
public class DRModelDaleLegs extends LOTRModelBiped {

	public DRModelDaleLegs() {
		textureWidth = 32;
		textureHeight = 32;
		...
		this.bipedRightLeg.cubeList.add(new ModelBox(this.bipedRightLeg, 20, 27, -2.5F, 5.0F, -2.5F, 3, 2, 3, 0.0F));

		ModelRenderer cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.bipedRightLeg.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.0F, 0.0F, 0.2618F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 16, 0, -2.2F, 0.5F, -2.0F, 0, 3, 4, 0.0F));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 4, 11, -2.2F, 3.5F, -1.5F, 0, 1, 3, 0.0F));

		this.bipedLeftLeg = new ModelRenderer(this);
		this.bipedLeftLeg.setRotationPoint(1.9F, 12.0F, 0.0F);
		this.bipedLeftLeg.cubeList.add(new ModelBox(this.bipedLeftLeg, 0, 0, -2.0F, 0.0F, -2.0F, 4, 9, 4, 0.25F));
		this.bipedLeftLeg.cubeList.add(new ModelBox(this.bipedLeftLeg, 0, 27, -0.5F, 5.0F, -2.5F, 3, 2, 3, 0.0F));

...
public class DRModelPoneyArmor extends ModelBase {
	...
	public DRModelPoneyArmor() {
		...
		body.addChild(selle);
		selle.cubeList.add(new ModelBox(selle, 10, 288, -9.0F, -12.0F, -7.0F, 18, 15, 19, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 108, 315, -10.0F, -10.0F, -6.0F, 2, 10, 5, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 140, 318, -10.5F, -10.1F, -6.0F, 2, 3, 5, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 108, 315, -10.0F, -10.0F, 6.0F, 2, 10, 5, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 140, 318, -10.5F, -10.1F, 6.0F, 2, 3, 5, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 140, 318, -10.5F, -8.1F, 0.0F, 2, 3, 5, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 144, 346, -10.2F, -7.1F, -3.0F, 2, 2, 1, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 144, 346, -10.2F, -5.1F, 3.0F, 2, 2, 1, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 144, 346, -10.2F, -7.1F, 9.0F, 2, 2, 1, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 144, 346, -10.2F, -7.1F, -5.0F, 2, 2, 1, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 144, 346, -10.2F, -5.1F, 1.0F, 2, 2, 1, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 144, 346, -10.2F, -7.1F, 7.0F, 2, 2, 1, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 108, 315, -10.0F, -8.0F, 0.0F, 2, 10, 5, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 33, 342, 8.0F, -10.0F, -3.0F, 2, 10, 13, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 33, 406, 8.5F, -10.25F, -3.0F, 2, 4, 13, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 116, 442, 8.25F, -6.25F, -1.0F, 2, 4, 1, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 116, 442, 8.25F, -7.25F, 2.0F, 2, 4, 1, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 116, 442, 8.25F, -6.25F, 6.0F, 2, 4, 1, 0.0F));

		hexadecagon = new ModelRenderer(this);
		hexadecagon.setRotationPoint(0.0F, -14.0F, 12.0F);
		selle.addChild(hexadecagon);
		hexadecagon.cubeList.add(new ModelBox(hexadecagon, 196, 345, -8.5F, -0.6962F, -3.5F, 17, 1, 7, 0.0F));
		hexadecagon.cubeList.add(new ModelBox(hexadecagon, 196, 345, -8.5F, -3.5F, -0.6962F, 17, 7, 1, 0.0F));
		...
		hexadecagon_r1.cubeList.add(new ModelBox(hexadecagon_r1, 196, 345, -8.5F, -3.5F, -0.6962F, 17, 7, 1, 0.0F));
		hexadecagon_r1.cubeList.add(new ModelBox(hexadecagon_r1, 196, 345, -8.5F, -0.6962F, -3.5F, 17, 1, 7, 0.0F));
		...
		hexadecagon_r2.cubeList.add(new ModelBox(hexadecagon_r2, 196, 345, -8.5F, -3.5F, -0.6962F, 17, 7, 1, 0.0F));
		hexadecagon_r2.cubeList.add(new ModelBox(hexadecagon_r2, 196, 345, -8.5F, -0.6962F, -3.5F, 17, 1, 7, 0.0F));
		...
		hexadecagon_r3.cubeList.add(new ModelBox(hexadecagon_r3, 196, 345, -8.5F, -0.6962F, -3.5F, 17, 1, 7, 0.0F));
		...
		hexadecagon_r4.cubeList.add(new ModelBox(hexadecagon_r4, 196, 345, -8.5F, -0.6962F, -3.5F, 17, 1, 7, 0.0F));

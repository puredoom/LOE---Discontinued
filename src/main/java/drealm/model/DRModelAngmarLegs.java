...
public class DRModelAngmarLegs extends LOTRModelBiped {

	public DRModelAngmarLegs() {
		textureWidth = 32;
		textureHeight = 32;
		...
		this.bipedRightLeg.cubeList.add(new ModelBox(this.bipedRightLeg, 30, 14, 0.0F, 4.8F, 2.3F, 1, 3, 0, 0.0F));
		...
		this.bipedRightLeg.cubeList.add(new ModelBox(this.bipedRightLeg, 30, 27, -1.0F, 4.8F, 2.3F, 1, 5, 0, 0.0F));
		...
		cube_r2.cubeList.add(new ModelBox(cube_r2, 28, 0, -0.6F, -0.2F, 1.0F, 1, 3, 1, 0.0F));
		cube_r2.cubeList.add(new ModelBox(cube_r2, 6, 20, -0.6F, -0.2F, -2.0F, 1, 3, 1, 0.0F));
		...
		this.bipedLeftLeg.cubeList.add(new ModelBox(this.bipedLeftLeg, 30, 27, 0.0F, 4.8F, 2.3F, 1, 5, 0, 0.0F));
		this.bipedLeftLeg.cubeList.add(new ModelBox(this.bipedLeftLeg, 30, 14, -1.0F, 4.8F, 2.3F, 1, 3, 0, 0.0F));
		...
		cube_r4.cubeList.add(new ModelBox(cube_r4, 6, 20, -0.4F, -0.2F, -2.0F, 1, 3, 1, 0.0F));
		cube_r4.cubeList.add(new ModelBox(cube_r4, 0, 19, -0.4F, -0.2F, -1.0F, 1, 5, 2, 0.0F));
		cube_r4.cubeList.add(new ModelBox(cube_r4, 28, 0, -0.4F, -0.2F, 1.0F, 1, 3, 1, 0.0F));
	}

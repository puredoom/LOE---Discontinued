...
public class DRModelIsengardBody extends LOTRModelBiped {
	public DRModelIsengardBody() {
		textureWidth = 64;
		textureHeight = 64;
		...
		this.bipedRightArm.cubeList.add(new ModelBox(this.bipedRightArm, 0, 2, -1.3F, -3.3F, 1.5F, 1, 1, 1, 0.0F));
		this.bipedRightArm.cubeList.add(new ModelBox(this.bipedRightArm, 2, 41, -0.8F, -4.8F, -3.0F, 0, 2, 6, 0.0F));
		this.bipedRightArm.cubeList.add(new ModelBox(this.bipedRightArm, 0, 2, -1.3F, -3.3F, -2.5F, 1, 1, 1, 0.0F));
		this.bipedRightArm.cubeList.add(new ModelBox(this.bipedRightArm, 34, 22, -1.3F, -3.8F, -2.0F, 1, 2, 4, 0.0F));

		ModelRenderer cube_r29 = new ModelRenderer(this);
		cube_r29.setRotationPoint(-3.7F, 5.8F, 0.7F);
		this.bipedRightArm.addChild(cube_r29);
		setRotationAngle(cube_r29, -0.035F, 0.2595F, 0.3881F);
		cube_r29.cubeList.add(new ModelBox(cube_r29, 44, 32, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r30 = new ModelRenderer(this);
		cube_r30.setRotationPoint(-3.7F, 4.8F, 0.7F);
		this.bipedRightArm.addChild(cube_r30);
		setRotationAngle(cube_r30, -0.035F, 0.2595F, 0.3881F);
		cube_r30.cubeList.add(new ModelBox(cube_r30, 44, 36, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r31 = new ModelRenderer(this);
		cube_r31.setRotationPoint(-3.7F, 3.8F, 0.7F);
		this.bipedRightArm.addChild(cube_r31);
		setRotationAngle(cube_r31, -0.035F, 0.2595F, 0.3881F);
		cube_r31.cubeList.add(new ModelBox(cube_r31, 40, 44, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r32 = new ModelRenderer(this);
		cube_r32.setRotationPoint(-3.7F, 5.8F, -0.7F);
		this.bipedRightArm.addChild(cube_r32);
		setRotationAngle(cube_r32, 0.035F, -0.2595F, 0.3881F);
		cube_r32.cubeList.add(new ModelBox(cube_r32, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r33 = new ModelRenderer(this);
		cube_r33.setRotationPoint(-3.7F, 4.8F, -0.7F);
		this.bipedRightArm.addChild(cube_r33);
		setRotationAngle(cube_r33, 0.035F, -0.2595F, 0.3881F);
		cube_r33.cubeList.add(new ModelBox(cube_r33, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r34 = new ModelRenderer(this);
		cube_r34.setRotationPoint(-3.7F, 3.8F, -0.7F);
		this.bipedRightArm.addChild(cube_r34);
		setRotationAngle(cube_r34, 0.035F, -0.2595F, 0.3881F);
		cube_r34.cubeList.add(new ModelBox(cube_r34, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));
		...
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 34, 22, 0.3F, -3.8F, -2.0F, 1, 2, 4, 0.0F));
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 2, 41, 0.8F, -4.8F, -3.0F, 0, 2, 6, 0.0F));
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 0, 2, 0.3F, -3.3F, -2.5F, 1, 1, 1, 0.0F));
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 0, 2, 0.3F, -3.3F, 1.5F, 1, 1, 1, 0.0F));

		ModelRenderer cube_r35 = new ModelRenderer(this);
		cube_r35.setRotationPoint(3.7F, 5.8F, 0.7F);
		this.bipedLeftArm.addChild(cube_r35);
		setRotationAngle(cube_r35, -0.035F, -0.2595F, -0.3881F);
		cube_r35.cubeList.add(new ModelBox(cube_r35, 44, 32, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r36 = new ModelRenderer(this);
		cube_r36.setRotationPoint(3.7F, 4.8F, 0.7F);
		this.bipedLeftArm.addChild(cube_r36);
		setRotationAngle(cube_r36, -0.035F, -0.2595F, -0.3881F);
		cube_r36.cubeList.add(new ModelBox(cube_r36, 44, 36, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r37 = new ModelRenderer(this);
		cube_r37.setRotationPoint(3.7F, 3.8F, 0.7F);
		this.bipedLeftArm.addChild(cube_r37);
		setRotationAngle(cube_r37, -0.035F, -0.2595F, -0.3881F);
		cube_r37.cubeList.add(new ModelBox(cube_r37, 40, 44, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r38 = new ModelRenderer(this);
		cube_r38.setRotationPoint(3.7F, 5.8F, -0.7F);
		this.bipedLeftArm.addChild(cube_r38);
		...
		cube_r39.setRotationPoint(3.7F, 4.8F, -0.7F);
		...
		cube_r40.setRotationPoint(3.7F, 3.8F, -0.7F);
		this.bipedLeftArm.addChild(cube_r40);
		setRotationAngle(cube_r40, 0.035F, 0.2595F, -0.3881F);
		cube_r40.cubeList.add(new ModelBox(cube_r40, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));
	}

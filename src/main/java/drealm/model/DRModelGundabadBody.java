...
public class DRModelGundabadBody extends LOTRModelBiped {

	public DRModelGundabadBody() {
		textureWidth = 64;
		textureHeight = 64;
		...
		cube_r1.cubeList.add(new ModelBox(cube_r1, 34, 30, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r2.cubeList.add(new ModelBox(cube_r2, 34, 30, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r3.cubeList.add(new ModelBox(cube_r3, 34, 34, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r4.cubeList.add(new ModelBox(cube_r4, 32, 38, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r5.cubeList.add(new ModelBox(cube_r5, 34, 34, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r6.cubeList.add(new ModelBox(cube_r6, 32, 38, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r7.cubeList.add(new ModelBox(cube_r7, 38, 9, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r8.cubeList.add(new ModelBox(cube_r8, 38, 9, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r9.cubeList.add(new ModelBox(cube_r9, 22, 41, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r10.cubeList.add(new ModelBox(cube_r10, 22, 41, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r11.cubeList.add(new ModelBox(cube_r11, 0, 39, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 39, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r13.cubeList.add(new ModelBox(cube_r13, 0, 32, -3.0F, -4.0F, -1.0F, 4, 5, 2, 0.0F));
		...
		cube_r14.cubeList.add(new ModelBox(cube_r14, 0, 32, -1.0F, -4.0F, -1.0F, 4, 5, 2, 0.0F));
		...
		cube_r15.cubeList.add(new ModelBox(cube_r15, 40, 20, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r16.cubeList.add(new ModelBox(cube_r16, 22, 41, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r17.cubeList.add(new ModelBox(cube_r17, 0, 39, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r18.cubeList.add(new ModelBox(cube_r18, 0, 39, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r19.cubeList.add(new ModelBox(cube_r19, 42, 13, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r20.cubeList.add(new ModelBox(cube_r20, 40, 20, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r21.cubeList.add(new ModelBox(cube_r21, 40, 20, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r22.cubeList.add(new ModelBox(cube_r22, 22, 41, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r23.cubeList.add(new ModelBox(cube_r23, 42, 13, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r24.cubeList.add(new ModelBox(cube_r24, 40, 20, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r25.cubeList.add(new ModelBox(cube_r25, 12, 39, -1.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r26.cubeList.add(new ModelBox(cube_r26, 12, 39, -3.0F, -2.0F, -1.0F, 4, 2, 2, 0.0F));
		...
		cube_r27.cubeList.add(new ModelBox(cube_r27, 12, 32, -3.0F, -4.0F, -1.0F, 4, 5, 2, 0.0F));
		...
		cube_r28.cubeList.add(new ModelBox(cube_r28, 12, 32, -1.0F, -4.0F, -1.0F, 4, 5, 2, 0.0F));

		this.bipedRightArm = new ModelRenderer(this);
		this.bipedRightArm.setRotationPoint(-5.0F, 2.0F, 0.0F);
		this.bipedRightArm.cubeList.add(new ModelBox(this.bipedRightArm, 16, 16, -4.0F, 0.5F, -3.0F, 5, 1, 6, 0.25F));
		this.bipedRightArm.cubeList.add(new ModelBox(this.bipedRightArm, 32, 14, -3.0F, -2.0F, 1.25F, 4, 7, 1, 0.25F));
		this.bipedRightArm.cubeList.add(new ModelBox(this.bipedRightArm, 16, 23, -3.5F, -2.5F, -2.5F, 5, 4, 5, 0.25F));
		this.bipedRightArm.cubeList.add(new ModelBox(this.bipedRightArm, 24, 0, -3.25F, -2.0F, -2.0F, 4, 7, 4, 0.25F));
		this.bipedRightArm.cubeList.add(new ModelBox(this.bipedRightArm, 24, 32, -3.0F, -2.0F, -2.25F, 4, 7, 1, 0.25F));
		...
		cube_r29.cubeList.add(new ModelBox(cube_r29, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));
		...
		cube_r30.cubeList.add(new ModelBox(cube_r30, 44, 32, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));
		...
		cube_r31.cubeList.add(new ModelBox(cube_r31, 44, 36, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r32 = new ModelRenderer(this);
		cube_r32.setRotationPoint(-3.7F, 3.8F, 0.7F);
		this.bipedRightArm.addChild(cube_r32);
		setRotationAngle(cube_r32, -0.035F, 0.2595F, 0.3881F);
		cube_r32.cubeList.add(new ModelBox(cube_r32, 40, 44, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r33 = new ModelRenderer(this);
		cube_r33.setRotationPoint(-3.7F, 7.8F, 0.7F);
		this.bipedRightArm.addChild(cube_r33);
		setRotationAngle(cube_r33, -0.035F, 0.2595F, 0.3881F);
		cube_r33.cubeList.add(new ModelBox(cube_r33, 8, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r34 = new ModelRenderer(this);
		cube_r34.setRotationPoint(-2.4F, -2.7F, 0.5F);
		this.bipedRightArm.addChild(cube_r34);
		setRotationAngle(cube_r34, 0.0F, 0.0F, -0.3927F);
		cube_r34.cubeList.add(new ModelBox(cube_r34, 34, 22, -0.5F, -1.1F, -2.5F, 1, 2, 4, 0.0F));
		cube_r34.cubeList.add(new ModelBox(cube_r34, 0, 2, -0.5F, -0.6F, -3.0F, 1, 1, 1, 0.0F));
		cube_r34.cubeList.add(new ModelBox(cube_r34, 2, 41, 0.0F, -3.1F, -3.5F, 0, 3, 6, 0.0F));
		cube_r34.cubeList.add(new ModelBox(cube_r34, 0, 2, -0.5F, -0.6F, 1.0F, 1, 1, 1, 0.0F));

		ModelRenderer cube_r35 = new ModelRenderer(this);
		cube_r35.setRotationPoint(-3.7F, 6.8F, -0.7F);
		this.bipedRightArm.addChild(cube_r35);
		setRotationAngle(cube_r35, 0.035F, -0.2595F, 0.3881F);
		cube_r35.cubeList.add(new ModelBox(cube_r35, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r36 = new ModelRenderer(this);
		cube_r36.setRotationPoint(-3.7F, 5.8F, -0.7F);
		this.bipedRightArm.addChild(cube_r36);
		setRotationAngle(cube_r36, 0.035F, -0.2595F, 0.3881F);
		cube_r36.cubeList.add(new ModelBox(cube_r36, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r37 = new ModelRenderer(this);
		cube_r37.setRotationPoint(-3.7F, 4.8F, -0.7F);
		this.bipedRightArm.addChild(cube_r37);
		setRotationAngle(cube_r37, 0.035F, -0.2595F, 0.3881F);
		cube_r37.cubeList.add(new ModelBox(cube_r37, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r38 = new ModelRenderer(this);
		cube_r38.setRotationPoint(-3.7F, 3.8F, -0.7F);
		this.bipedRightArm.addChild(cube_r38);
		setRotationAngle(cube_r38, 0.035F, -0.2595F, 0.3881F);
		cube_r38.cubeList.add(new ModelBox(cube_r38, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r39 = new ModelRenderer(this);
		cube_r39.setRotationPoint(-3.7F, 7.8F, -0.7F);
		this.bipedRightArm.addChild(cube_r39);
		setRotationAngle(cube_r39, 0.035F, -0.2595F, 0.3881F);
		cube_r39.cubeList.add(new ModelBox(cube_r39, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		this.bipedLeftArm = new ModelRenderer(this);
		this.bipedLeftArm.setRotationPoint(5.0F, 2.0F, 0.0F);
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 0, 16, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.25F));
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 24, 0, -0.75F, -2.0F, -2.0F, 4, 7, 4, 0.25F));
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 24, 32, -1.0F, -2.0F, -2.25F, 4, 7, 1, 0.25F));
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 32, 14, -1.0F, -2.0F, 1.25F, 4, 7, 1, 0.25F));
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 16, 23, -1.5F, -2.5F, -2.5F, 5, 4, 5, 0.25F));
		this.bipedLeftArm.cubeList.add(new ModelBox(this.bipedLeftArm, 16, 16, -1.0F, 0.5F, -3.0F, 5, 1, 6, 0.25F));

		ModelRenderer cube_r40 = new ModelRenderer(this);
		cube_r40.setRotationPoint(2.4F, -2.7F, 0.5F);
		this.bipedLeftArm.addChild(cube_r40);
		setRotationAngle(cube_r40, 0.0F, 0.0F, 0.3927F);
		cube_r40.cubeList.add(new ModelBox(cube_r40, 0, 2, -0.5F, -0.6F, 1.0F, 1, 1, 1, 0.0F));
		cube_r40.cubeList.add(new ModelBox(cube_r40, 0, 2, -0.5F, -0.6F, -3.0F, 1, 1, 1, 0.0F));
		cube_r40.cubeList.add(new ModelBox(cube_r40, 2, 41, 0.0F, -3.1F, -3.5F, 0, 3, 6, 0.0F));
		cube_r40.cubeList.add(new ModelBox(cube_r40, 34, 22, -0.5F, -1.1F, -2.5F, 1, 2, 4, 0.0F));

		ModelRenderer cube_r41 = new ModelRenderer(this);
		cube_r41.setRotationPoint(3.7F, 7.8F, 0.7F);
		this.bipedLeftArm.addChild(cube_r41);
		setRotationAngle(cube_r41, -0.035F, -0.2595F, -0.3881F);
		cube_r41.cubeList.add(new ModelBox(cube_r41, 8, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r42 = new ModelRenderer(this);
		cube_r42.setRotationPoint(3.7F, 6.8F, 0.7F);
		this.bipedLeftArm.addChild(cube_r42);
		setRotationAngle(cube_r42, -0.035F, -0.2595F, -0.3881F);
		cube_r42.cubeList.add(new ModelBox(cube_r42, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r43 = new ModelRenderer(this);
		cube_r43.setRotationPoint(3.7F, 5.8F, 0.7F);
		this.bipedLeftArm.addChild(cube_r43);
		setRotationAngle(cube_r43, -0.035F, -0.2595F, -0.3881F);
		cube_r43.cubeList.add(new ModelBox(cube_r43, 44, 32, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r44 = new ModelRenderer(this);
		cube_r44.setRotationPoint(3.7F, 4.8F, 0.7F);
		this.bipedLeftArm.addChild(cube_r44);
		setRotationAngle(cube_r44, -0.035F, -0.2595F, -0.3881F);
		cube_r44.cubeList.add(new ModelBox(cube_r44, 44, 36, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r45 = new ModelRenderer(this);
		cube_r45.setRotationPoint(3.7F, 3.8F, 0.7F);
		this.bipedLeftArm.addChild(cube_r45);
		setRotationAngle(cube_r45, -0.035F, -0.2595F, -0.3881F);
		cube_r45.cubeList.add(new ModelBox(cube_r45, 40, 44, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r46 = new ModelRenderer(this);
		cube_r46.setRotationPoint(3.7F, 7.8F, -0.7F);
		this.bipedLeftArm.addChild(cube_r46);
		setRotationAngle(cube_r46, 0.035F, 0.2595F, -0.3881F);
		cube_r46.cubeList.add(new ModelBox(cube_r46, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r47 = new ModelRenderer(this);
		cube_r47.setRotationPoint(3.7F, 6.8F, -0.7F);
		this.bipedLeftArm.addChild(cube_r47);
		setRotationAngle(cube_r47, 0.035F, 0.2595F, -0.3881F);
		cube_r47.cubeList.add(new ModelBox(cube_r47, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r48 = new ModelRenderer(this);
		cube_r48.setRotationPoint(3.7F, 5.8F, -0.7F);
		this.bipedLeftArm.addChild(cube_r48);
		setRotationAngle(cube_r48, 0.035F, 0.2595F, -0.3881F);
		cube_r48.cubeList.add(new ModelBox(cube_r48, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r49 = new ModelRenderer(this);
		cube_r49.setRotationPoint(3.7F, 4.8F, -0.7F);
		this.bipedLeftArm.addChild(cube_r49);
		setRotationAngle(cube_r49, 0.035F, 0.2595F, -0.3881F);
		cube_r49.cubeList.add(new ModelBox(cube_r49, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));

		ModelRenderer cube_r50 = new ModelRenderer(this);
		cube_r50.setRotationPoint(3.7F, 3.8F, -0.7F);
		this.bipedLeftArm.addChild(cube_r50);
		setRotationAngle(cube_r50, 0.035F, 0.2595F, -0.3881F);
		cube_r50.cubeList.add(new ModelBox(cube_r50, 16, 43, -1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F));
	}

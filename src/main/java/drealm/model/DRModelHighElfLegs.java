...
public class DRModelHighElfLegs extends LOTRModelBiped {


	public DRModelHighElfLegs() {
		textureWidth = 32;
		textureHeight = 32;
		...
		cube_r5.cubeList.add(new ModelBox(cube_r5, 16, 17, 0.0F, -2.0F, -4.0F, 1, 3, 2, 0.0F));
		cube_r5.cubeList.add(new ModelBox(cube_r5, 16, 0, 0.0F, -4.0F, -2.0F, 1, 2, 3, 0.0F));
		cube_r5.cubeList.add(new ModelBox(cube_r5, 10, 13, 0.0F, -2.0F, -2.0F, 1, 3, 3, 0.0F));
		...
		cube_r8.cubeList.add(new ModelBox(cube_r8, 0, 20, 1.0F, 17.6F, 1.8F, 3, 1, 1, 0.0F));

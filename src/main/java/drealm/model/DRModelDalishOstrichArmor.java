...
public class DRModelDalishOstrichArmor extends ModelBase {
	...
	public DRModelDalishOstrichArmor() {
		textureWidth = 256;
		textureHeight = 256;

		body = new ModelRenderer(this);
		body.setRotationPoint(0.0F, -12.0F, 0.0F);
		body.cubeList.add(new ModelBox(body, 0, 66, -11.0F, -11.0F, -11.0F, 22, 20, 22, 0.0F));
		body.cubeList.add(new ModelBox(body, 66, 76, -13.0F, -8.0F, -4.0F, 2, 2, 8, 0.0F));
		body.cubeList.add(new ModelBox(body, 136, 0, -13.0F, -6.0F, -6.0F, 2, 2, 12, 0.0F));
		body.cubeList.add(new ModelBox(body, 28, 126, -13.0F, -4.0F, -6.0F, 2, 2, 13, 0.0F));
		body.cubeList.add(new ModelBox(body, 56, 108, -13.0F, -2.0F, -6.0F, 2, 2, 14, 0.0F));
		body.cubeList.add(new ModelBox(body, 36, 108, -13.0F, 0.0F, -6.0F, 2, 2, 16, 0.0F));
		body.cubeList.add(new ModelBox(body, 0, 116, -13.0F, 2.0F, -4.0F, 2, 2, 6, 0.0F));
		body.cubeList.add(new ModelBox(body, 0, 108, 11.0F, 0.0F, -6.0F, 2, 2, 16, 0.0F));
		body.cubeList.add(new ModelBox(body, 0, 108, 11.0F, 2.0F, -4.0F, 2, 2, 6, 0.0F));
		body.cubeList.add(new ModelBox(body, 20, 108, 11.0F, -2.0F, -6.0F, 2, 2, 14, 0.0F));
		body.cubeList.add(new ModelBox(body, 123, 125, 11.0F, -4.0F, -6.0F, 2, 2, 13, 0.0F));
		body.cubeList.add(new ModelBox(body, 46, 129, 11.0F, -6.0F, -6.0F, 2, 2, 12, 0.0F));
		body.cubeList.add(new ModelBox(body, 66, 66, 11.0F, -8.0F, -4.0F, 2, 2, 8, 0.0F));

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(0.0F, -2.0F, -18.0F);
		...
		cube_r2.setRotationPoint(0.0F, -2.0F, -18.0F);
		...
		cube_r3.setRotationPoint(0.0F, -11.0F, -11.0F);
		...
		cube_r4.setRotationPoint(0.0F, -1.0F, 11.0F);
		...
		selle.setRotationPoint(0.0F, -23.0F, 0.0F);
		selle.cubeList.add(new ModelBox(selle, 105, 211, -10.0F, -1.0F, -9.0F, 20, 1, 18, 0.0F));
		selle.cubeList.add(new ModelBox(selle, 123, 191, -10.0F, -17.0F, 11.0F, 20, 8, 1, 0.0F));

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(-10.0F, 0.0F, -8.0F);
		selle.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.1745F, 0.0F, 0.0F);
		cube_r5.cubeList.add(new ModelBox(cube_r5, 39, 214, 0.0F, -36.0F, -1.0F, 1, 36, 1, 0.0F));
		cube_r5.cubeList.add(new ModelBox(cube_r5, 39, 214, 19.0F, -36.0F, -1.0F, 1, 36, 1, 0.0F));

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(0.0F, -36.0F, -6.2F);
		selle.addChild(cube_r6);
		setRotationAngle(cube_r6, -3.0107F, 0.0F, 0.0F);
		cube_r6.cubeList.add(new ModelBox(cube_r6, 188, 154, -10.0F, -0.1432F, -0.7984F, 20, 1, 10, 0.0F));

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(0.0F, -33.0F, 1.8F);
		selle.addChild(cube_r7);
		setRotationAngle(cube_r7, 2.7925F, 0.0F, 0.0F);
		cube_r7.cubeList.add(new ModelBox(cube_r7, 188, 154, -10.0F, -0.1432F, -0.7984F, 20, 1, 10, 0.0F));

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(0.0F, -26.0F, 7.8F);
		selle.addChild(cube_r8);
		setRotationAngle(cube_r8, 2.2689F, 0.0F, 0.0F);
		cube_r8.cubeList.add(new ModelBox(cube_r8, 188, 154, -10.0F, -0.1432F, -0.7984F, 20, 1, 10, 0.0F));

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(0.0F, -25.0F, 9.0F);
		selle.addChild(cube_r9);
		setRotationAngle(cube_r9, 1.9199F, 0.0F, 0.0F);
		cube_r9.cubeList.add(new ModelBox(cube_r9, 188, 154, -10.0F, -1.0F, -9.0F, 20, 1, 10, 0.0F));

		cube_r10 = new ModelRenderer(this);
		cube_r10.setRotationPoint(0.0F, -1.0F, 9.0F);
		selle.addChild(cube_r10);
		setRotationAngle(cube_r10, -1.9199F, 0.0F, 0.0F);
		cube_r10.cubeList.add(new ModelBox(cube_r10, 188, 198, -10.0F, 0.0F, -9.0F, 20, 1, 10, 0.0F));
	}

...
public class DRModelHalfTrollBoots extends LOTRModelBiped {


	public DRModelHalfTrollBoots() {
		textureWidth = 32;
		textureHeight = 32;
		...
		ModelRenderer hexadecagon = new ModelRenderer(this);
		hexadecagon.setRotationPoint(0.0F, 11.0F, 0.0F);
	}

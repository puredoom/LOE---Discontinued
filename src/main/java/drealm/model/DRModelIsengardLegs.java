...
public class DRModelIsengardLegs extends LOTRModelBiped {


	public DRModelIsengardLegs() {
		textureWidth = 32;
		textureHeight = 32;
		...
		cube_r1.cubeList.add(new ModelBox(cube_r1, 10, 0, -1.2F, 0.0F, 2.1F, 2, 1, 1, 0.0F));

		ModelRenderer cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-2.0F, 11.0F, -2.0F);
		this.bipedRightLeg.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.1309F, 0.0F, -0.1309F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 14, 0, -0.5F, -6.0F, -0.5F, 3, 6, 3, 0.0F));
		...
		cube_r4.cubeList.add(new ModelBox(cube_r4, 28, 0, -0.6F, -0.2F, 1.0F, 1, 3, 1, 0.0F));
		cube_r4.cubeList.add(new ModelBox(cube_r4, 6, 20, -0.6F, -0.2F, -2.0F, 1, 3, 1, 0.0F));
		cube_r4.cubeList.add(new ModelBox(cube_r4, 0, 19, -0.6F, -0.2F, -1.0F, 1, 5, 2, 0.0F));
